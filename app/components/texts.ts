...
export const webPageText: Record<Language, TextContent> = {
    EN: {
        ...
        SkillsSection: {
            skill_categories: ["Programming Languages", "Database Management", "Cloud Services", "Infrastructure as Code", "Containerisation & Orchestration", "Data Pipelines", "APIs & Web Servers", "Version Control", "Testing", "Data Analysis", "Visualisation Tools", "AI Frameworks", "Website Development", "Methodology"]
        },
        ProjectSection: {
            title: "Projects",
    ...
    FR: {
        ...
        SkillsSection: {
            skill_categories: ["Langages de Programmation", "Gestion de Bases de Données", "Services Cloud", "Infrastructure as Code", "Conteneurisation & Orchestration", "Pipelines de Données", "APIs & Serveurs Web", "Contrôle de Version", "Tests", "Analyse des Données", "Outils de Visualisation", "Frameworks IA", "Développement Web", "Méthodologie"]
        },
        ProjectSection: {
            title: "Projets",
    ...
    HeroSection: {
        ...
        SkillsSection: {
            skill_categories: ["Lenguajes de Programación", "Gestión de Bases de Datos", "Servicios en la Nube", "Infrastructure as Code", "Contenedorización y Orquestación", "Pipelines de Datos", "APIs y Servidores Web", "Control de Versiones", "Pruebas", "Análisis de Datos", "Herramientas de Visualización", "Frameworks de IA", "Desarrollo Web", "Metodología"]
        },
        ProjectSection: {
            title: "Proyectos",
    ...
    DE: {
        ...
        SkillsSection: {
            skill_categories: ["Programmiersprachen", "Datenbankverwaltung", "Cloud-Dienste", "Infrastructure as Code", "Containerisierung & Orchestrierung", "Datenpipelines", "APIs & Webserver", "Versionskontrolle", "Tests", "Datenanalyse", "Visualisierungstools", "KI-Frameworks", "Webentwicklung", "Methodik"]
        },
        ProjectSection: {
            title: "Projekte",
