...
export const webPageText: Record<Language, TextContent> = {
    EN: {
        ...
        SkillsSection: {
            skill_categories: ["Programming Languages", "Database Management", "Database Modelling", "Cloud Services", "Infrastructure as Code", "DevOps", "Containerisation & Orchestration", "Data Pipelines", "APIs & Web Servers", "Web Development", "Version Control", "Testing", "Data Analysis", "Visualisation Tools", "AI Frameworks", "Methodology"]
        },
        ProjectSection: {
            title: "Projects",
            website_link_button: "View App",
            github_link_button: "View GitHub",
            project_titles: ["The New York Times Solver", "ETL Pipeline (AWS)", "GDPR Obfuscator Project", "Financial Fraud Detection"]
        },
        ContactSection: {
    ...
    FR: {
        ...
        SkillsSection: {
            skill_categories: ["Langages de Programmation", "Gestion de Bases de Données", "Modélisation de bases de données", "Services Cloud", "Infrastructure as Code", "DevOps", "Conteneurisation & Orchestration", "Pipelines de Données", "APIs & Serveurs Web", "Développement Web", "Contrôle de Version", "Tests", "Analyse des Données", "Outils de Visualisation", "Frameworks IA", "Méthodologie"]
        },
        ProjectSection: {
            title: "Projets",
            website_link_button: "Voir l'Application",
            github_link_button: "Voir GitHub",
            project_titles: ["Le Résolveur du New York Times", "Pipeline ETL (AWS)", "Projet d'Obfuscation RGPD", "Détection de fraude financière"]
        },
        ContactSection: {
    ...
    HeroSection: {
        ...
        SkillsSection: {
            skill_categories: ["Lenguajes de Programación", "Gestión de Bases de Datos", "Modelado de Bases de Datos", "Servicios en la Nube", "Infrastructure as Code", "DevOps", "Contenerización y Orquestación", "Pipelines de Datos", "APIs y Servidores Web", "Desarrollo Web", "Control de Versiones", "Pruebas", "Análisis de Datos", "Herramientas de Visualización", "Frameworks de IA", "Metodología"]
        },
        ProjectSection: {
            title: "Proyectos",
            website_link_button: "Ver la Aplicación",
            github_link_button: "Ver GitHub",
            project_titles: ["El Solucionador del New York Times", "Pipeline ETL (AWS)", "Proyecto de Ofuscación de GDPR", "Detección de fraude financiero"]
        },
        ContactSection: {
    ...
    DE: {
        ...
        SkillsSection: {
            skill_categories: ["Programmiersprachen", "Datenbankverwaltung", "Datenbankmodellierung", "Cloud-Dienste", "Infrastructure as Code", "DevOps", "Containerisierung & Orchestrierung", "Datenpipelines", "APIs & Webserver", "Webentwicklung", "Versionskontrolle", "Testen", "Datenanalyse", "Visualisierungstools", "KI-Frameworks", "Methodik"]
        },
        ProjectSection: {
            title: "Projekte",
            website_link_button: "App Anzeigen",
            github_link_button: "GitHub Anzeigen",
            project_titles: ["Der New York Times Löser", "ETL-Pipeline (AWS)", "GDPR-Verschleierungsprojekt", "Erkennung von Finanzbetrug"]
        },
        ContactSection: {
